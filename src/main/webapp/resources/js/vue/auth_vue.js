...
auth_vue = {
      ...
      login_body : x=>{
            ...
            '    <h1 class="h3 mb-3 font-weight-normal">MONEYHUB</h1>'+
            '    <label for="cemail" class="sr-only">Email address</label>'+
            '    <input type="text" id="cemail" class="form-control" placeholder="ID" required="" autofocus="">'+
            '    <label for="inputPassword" class="sr-only">Password</label>'+
            '    <input type="password" id="cpwd" class="form-control" placeholder="PASSWORD" required="">'+
