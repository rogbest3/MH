...
brd_vue = {
	...
	brd_body: x =>{
		...
		'    <div id="menubar" class="nav-scroller bg-white box-shadow">'+
		'      <nav class="nav nav-underline">'+
		'        <a class="nav-link active" href="#"><i class="fas fa-bomb fa-2x"></i></a>'+
		...
		'      <div id="board" class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded box-shadow">'+
